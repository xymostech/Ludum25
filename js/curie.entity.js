var CurieEntity = (function(){

var CurieEntity = CGSGNode.extend({
    initialize: function(parent) {
        this._super(700, 850, 15, 35);
    ...
    _setup: function() {
        ...
        this.sprite.backhair = new CGSGNodeRealCircle(0, 2, 5);
        this.sprite.backhair.color = "gray";
        this.sprite.behind.addChild(this.sprite.backhair);

        this.sprite.hair = new CGSGNodeSquare(0, 0, 15, 4);
        this.sprite.hair.color = "gray";
        this.sprite.head.addChild(this.sprite.hair);

        this.sprite.head.color = "lightgreen";
        this.sprite.lleg.color = "black";
        this.sprite.rleg.color = "black";
        this.sprite.larm.color = "lightgreen";
        this.sprite.rarm.color = "lightgreen";
        this.sprite.body.color = "lightblue";
    },
    ...
    die: function() {
        this.parent.parent.changeScene("test");
    },
