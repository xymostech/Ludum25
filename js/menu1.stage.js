var Menu1Stage = (function(){

var Menu1Stage = CGSGNode.extend({
    ...
    choose: function() {
        if (this.selection === 0) {
            ...
            this.textControl.setText(["You", "No, I need to get the plans before I can save my goat..."])
        } else if (this.selection === 2) {
            this.textControl.setText(["You", "Hmm, I think I need to save my goat before I can find the materials..."])
        }
    },
});
