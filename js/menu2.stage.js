var Menu2Stage = (function(){

var Menu2Stage = CGSGNode.extend({
    ...
    choose: function() {
        if (this.selection === 0) {
            ...
            this.textControl.setText(["You", "Hmm, I really still need to save my goat before I try to find the materials..."])
        }
    },
});
